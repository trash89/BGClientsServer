    ...
    try {
      ...
      if (userfile) {
        try {
          ...
          if (errorPublicURL) {
            return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ error: { ...errorPublicURL, msg: "getOneFile,storage.getPublicURL" } });
          }
          const obj = {
            ...userfile,
        ...
        try {
          ...
          try {
            ...
            if (errorUpload) {
              ...
              return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ error: { ...errorUpload, msg: "createFile,error on upload" } });
            }
            try {
              ...
              if (error) {
                ...
                return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ error: { ...error, msg: "createFile,insert files" } });
              }
              return res.status(StatusCodes.CREATED).json({ file, error });
            } catch (error) {
              return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ error });
            }
          } catch (error) {
      ...
      if (id) {
        try {
          ...
          try {
            ...
            if (errorDeleteFile) {
              return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ error: { ...errorDeleteFile, msg: "deleteFile, delete file" } });
            }
            try {
              ...
              if (errorDeletedFile) {
                return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ error: { ...errorDeletedFile, msg: "deleteFile,delete files" } });
              }
